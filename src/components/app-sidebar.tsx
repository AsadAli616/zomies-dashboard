...
const navigationItems = [
  ...
  { title: "Notes", url: "/teacher/notes", icon: BookOpen },
          ...
          <div className="mt-auto p-4 border-t border-sidebar-hover/30">
            <div className="bg-accent-orange/10 rounded-xl p-3">
              ...
              <p className="text-xs text-sidebar-foreground/80">
                Schedule quizzes for your students' weak topics to boost
                performance!
              </p>
            </div>
          </div>
